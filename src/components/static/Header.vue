<template>
  <header class="header float-box loading-translate">
    ...
    <span class="header-title">Abunjing bunjing</span>
    <div class="author"><span class="author-text">Made with </span><i class="heart fas fa-heart" /><span class="author-text"> by Abunjing Group</span></div>
  </header>
</template>
